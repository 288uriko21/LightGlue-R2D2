...
import argparse
from lightglue.models.modules.modules import Int8Conv2DModule, \
...
from lightglue.utilsz.utils import load_img, pre_process
...
class ZippyPoint(Extractor, tf.keras.Model):
    default_conf = {
        "descriptor_dim": 256,
        "nms_radius": 4,
    ...
    def __init__(self, descriptor_size=256, activation="hard_swish", binary_activation="relu", qmax=6.0,
        ...
        tf.keras.Model.__init__(self)  # Явный вызов конструктора для torch.nn.Module
    ...
    def forward(self, data: dict) -> dict:
        ...
        # python demo.py --output_dir ./tmpdir/ --query_imgs ./assets/query --ref_img ./assets/reference/1341847980.722988.png
